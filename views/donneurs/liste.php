...
// Calcul des statistiques à partir du tableau $donneurs
$totalDonneurs = count($donneurs);
$donneursMasculins = count(array_filter($donneurs, fn($donneur) => $donneur['Genre'] === 'M'));
$donneursFeminins = count(array_filter($donneurs, fn($donneur) => $donneur['Genre'] === 'F'));
...
<body>
        ...
        <div class="row">
            ...
            <div class="main-content" id="mainContent">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div class="stats-card">
                            <i class="fas fa-male" style="color: var(--accent-blue);"></i>
                            <h3>Donneurs Masculins</h3>
                            <p><?php echo $donneursMasculins; ?></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stats-card">
                            <i class="fas fa-female" style="color: var(--danger-red);"></i>
                            <h3>Donneurs Féminins</h3>
                            <p><?php echo $donneursFeminins; ?></p>
                        </div>
                    </div>
                </div>

                <a href="index.php?action=ajouter_donneur" class="btn btn-primary mb-4">
                    <i class="fas fa-tint me-2"></i> Ajouter un donneur
                </a>
                    ...
                    <table class="table custom-table">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-calendar-alt me-1"></i> Date Remplissage</th>
                                <th><i class="fas fa-birthday-cake me-1"></i> Âge</th>
                                <th><i class="fas fa-venus-mars me-1"></i> Genre</th>
                                <th><i class="fas fa-user me-1"></i> Nom Donneur</th>
                        ...
                        <tbody>
                            <?php foreach ($donneurs as $donneur): ?>
                                <tr>
                                    ...
                                    <td><?php echo $donneur['Date_Remplissage']; ?></td>
                                    <td><?php echo $donneur['Age']; ?></td>
                                    <td>
                                        <?php if($donneur['Genre'] == 'M'): ?>
                                            <i class="fas fa-male text-primary me-1"></i>
                                        <?php else: ?>
                                            <i class="fas fa-female text-danger me-1"></i>
                                        <?php endif; ?>
                                        <?php echo $donneur['Genre']; ?>
                                    </td>
                                    <td><?php echo $donneur['nom']; ?></td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="index.php?action=info_donneur&id=<?php echo $donneur['ID']; ?>" class="btn btn-info">
                                                <i class="fas fa-info me-1"></i> Info
                                            </a>
                                            <a href="index.php?action=modifier_donneur&id=<?php echo $donneur['ID']; ?>" class="btn btn-warning">
                                                <i class="fas fa-edit me-1"></i> Modifier
                                            </a>
                                            <button onclick="confirmDelete(<?php echo $donneur['ID']; ?>)" class="btn btn-danger">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">Êtes-vous sûr de vouloir supprimer ce donneur ?</p>
    ...
    <script>
        ...
        function confirmDelete(id) {
            ...
            confirmButton.href = `index.php?action=supprimer_donneur&id=${id}`;
            deleteModal.show();
        }
