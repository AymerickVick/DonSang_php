            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-trash-alt"></i> Supprimer un Donneur</h1>
                    </div>
                ...
                <div class="form-container">
                    <div class="form-frame">
                        <p class="text-center mb-4">Êtes-vous sûr de vouloir supprimer le donneur suivant ?</p>
                        <ul class="list-group mb-4">
                            <li class="list-group-item">ID : <?php echo $donneur['ID']; ?></li>
                            <li class="list-group-item">Date de Remplissage : <?php echo $donneur['Date_Remplissage']; ?></li>
                            <li class="list-group-item">Profession : <?php echo $donneur['Profession']; ?></li>
                        </ul>
                        <form action="index.php?action=supprimer_donneur&id=<?php echo $donneur['ID']; ?>" method="POST" class="text-center">
                            <button type="submit" class="btn btn-danger"><i class="fas fa-trash me-2"></i>Oui, supprimer</button>
                            <a href="index.php?action=lister_donneurs" class="btn btn-secondary"><i class="fas fa-times me-2"></i>Non, annuler</a>
                        </form>
                    </div>
                </div>
            </div>
