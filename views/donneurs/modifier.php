...
<body>
            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-user-edit"></i> Modifier un Donneur</h1>
                    </div>
                ...
                <div class="form-container">
                    <div class="form-frame">
                        <form action="index.php?action=modifier_donneur&id=<?php echo $donneur['ID']; ?>" method="POST" class="w-100">
                            <div class="form-row">
                                <div>
                                    <label for="date_remplissage" class="form-label">Date de Remplissage</label>
                                    <input type="date" class="form-control" id="date_remplissage" name="date_remplissage" value="<?php echo $donneur['Date_Remplissage']; ?>" required>
                                </div>
                                <div>
                                    <label for="date_naissance" class="form-label">Date de Naissance</label>
                                    <input type="date" class="form-control" id="date_naissance" name="date_naissance" value="<?php echo $donneur['Date_Naissance']; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="nom" class="form-label">Nom du Donneur</label>
                                    <input type="text" class="form-control" id="nom" name="nom" value="<?php echo $donneur['nom']; ?>">
                                </div>
                                <div>
                                    <label for="niveau_etude" class="form-label">Niveau d'Étude</label>
                                    <input type="text" class="form-control" id="niveau_etude" name="niveau_etude" value="<?php echo $donneur['Niveau_Etude']; ?>">
                                </div>
                                <div>
                                    <label for="genre" class="form-label">Genre</label>
                                    <select class="form-select" id="genre" name="genre" required>
                                        <option value="M" <?php echo $donneur['Genre'] == 'M' ? 'selected' : ''; ?>>M</option>
                                        <option value="F" <?php echo $donneur['Genre'] == 'F' ? 'selected' : ''; ?>>F</option>
                                        <option value="Autre" <?php echo $donneur['Genre'] == 'Autre' ? 'selected' : ''; ?>>Autre</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="taille" name="taille" value="<?php echo $donneur['Taille']; ?>">
                                </div>
                                <div>
                                    <label for="poids" class="form-label">Poids (kg)</label>
                                    <input type="number" step="0.1" class="form-control" id="poids" name="poids" value="<?php echo $donneur['Poids']; ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="situation_matrimoniale" class="form-label">Situation Matrimoniale</label>
                                    <input type="text" class="form-control" id="situation_matrimoniale" name="situation_matrimoniale" value="<?php echo $donneur['Situation_Matrimoniale']; ?>">
                                </div>
                                <div>
                                    <label for="profession" class="form-label">Profession</label>
                                    <input type="text" class="form-control" id="profession" name="profession" value="<?php echo $donneur['Profession']; ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="arrondissement_residence" class="form-label">Arrondissement de Résidence</label>
                                    <input type="text" class="form-control" id="arrondissement_residence" name="arrondissement_residence" value="<?php echo $donneur['Arrondissement_Residence']; ?>">
                                </div>
                                <div>
                                    <label for="quartier_residence" class="form-label">Quartier de Résidence</label>
                                    <input type="text" class="form-control" id="quartier_residence" name="quartier_residence" value="<?php echo $donneur['Quartier_Residence']; ?>">
                                </div>
                            </div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            // Activer le sous-menu du donneur par défaut
        ...
        // Limite de date de naissance (21 ans minimum)
