...
<head>
    ...
    <title>Ajouter des Conditions de Santé</title>
            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-stethoscope"></i> Ajouter des Conditions de Santé</h1>
                    </div>
                ...
                <div class="form-container">
                    <div class="form-frame">
                        <form action="index.php?action=ajouter_condition" method="POST">
                            <div class="form-grid">
                                <div class="full-width">
                                    <label for="id_donneur" class="form-label">Donneur</label>
                                    <select class="form-select" id="id_donneur" name="id_donneur" required>
                                        <?php foreach ($donneurs as $donneur): ?>
                                            <option value="<?php echo $donneur['ID']; ?>">
                                ...
                                <div class="full-width">
                                    ...
                                    <textarea class="form-control" id="raison_non_eligibilite" name="raison_non_eligibilite" rows="3"></textarea>
                                </div>
                                <div class="full-width">
                                    <label class="form-label">Conditions de Santé</label>
                                    <div class="checkbox-grid">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="porteur_hiv" name="porteur_hiv">
                                            <label class="form-check-label" for="porteur_hiv">Porteur HIV</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="porteur_hbs" name="porteur_hbs">
                                            <label class="form-check-label" for="porteur_hbs">Porteur HBS</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="porteur_hcv" name="porteur_hcv">
                                            <label class="form-check-label" for="porteur_hcv">Porteur HCV</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="opere" name="opere">
                                            <label class="form-check-label" for="opere">Opéré</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="drepanocytaire" name="drepanocytaire">
                                            <label class="form-check-label" for="drepanocytaire">Drépanocytaire</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="diabetique" name="diabetique">
                                            <label class="form-check-label" for="diabetique">Diabétique</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="hypertendu" name="hypertendu">
                                            <label class="form-check-label" for="hypertendu">Hypertendu</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="asthmatique" name="asthmatique">
                                            <label class="form-check-label" for="asthmatique">Asthmatique</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="cardiaque" name="cardiaque">
                                            <label class="form-check-label" for="cardiaque">Cardiaque</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="tatoue" name="tatoue">
                                            <label class="form-check-label" for="tatoue">Tatoué</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="scarifie" name="scarifie">
