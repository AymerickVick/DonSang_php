...
<head>
    ...
    <title>Modifier des Conditions de Santé</title>
...
<body>
            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-edit"></i> Modifier des Conditions de Santé</h1>
                    </div>
                ...
                <div class="form-container">
                    <div class="form-frame">
                        <form action="index.php?action=modifier_condition&id=<?php echo $condition['ID_Donneur']; ?>" method="POST">
                            <div class="form-grid">
                                <div class="full-width">
                                    <label for="id_donneur" class="form-label">Donneur</label>
                                    <select style="color: black;" class="form-select" id="id_donneur" name="id_donneur" disabled>
                                        <?php foreach ($donneurs as $donneur): ?>
                                            <option value="<?php echo $donneur['ID']; ?>" <?php echo $donneur['ID'] == $condition['ID_Donneur'] ? 'selected' : ''; ?> >
                                                <?php echo $donneur['nom'] . " (ID: " . $donneur['ID'] . ")"; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="full-width">
                                    <label for="raison_non_eligibilite" class="form-label">Raison de Non-Éligibilité</label>
                                    <textarea class="form-control" id="raison_non_eligibilite" name="raison_non_eligibilite" rows="3"><?php echo $condition['Raison_Non_Eligibilite']; ?></textarea>
                                </div>
                                <div class="full-width">
                                    <label class="form-label">Conditions de Santé</label>
                                    <div class="checkbox-grid">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="porteur_hiv" name="porteur_hiv" <?php echo $condition['Porteur_HIV'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="porteur_hiv">Porteur HIV</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="porteur_hbs" name="porteur_hbs" <?php echo $condition['Porteur_HBS'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="porteur_hbs">Porteur HBS</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="porteur_hcv" name="porteur_hcv" <?php echo $condition['Porteur_HCV'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="porteur_hcv">Porteur HCV</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="opere" name="opere" <?php echo $condition['Opere'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="opere">Opéré</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="drepanocytaire" name="drepanocytaire" <?php echo $condition['Drepanocytaire'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="drepanocytaire">Drépanocytaire</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="diabetique" name="diabetique" <?php echo $condition['Diabetique'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="diabetique">Diabétique</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="hypertendu" name="hypertendu" <?php echo $condition['Hypertendu'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="hypertendu">Hypertendu</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="asthmatique" name="asthmatique" <?php echo $condition['Asthmatique'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="asthmatique">Asthmatique</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="cardiaque" name="cardiaque" <?php echo $condition['Cardiaque'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="cardiaque">Cardiaque</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="tatoue" name="tatoue" <?php echo $condition['Tatoue'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="tatoue">Tatoué</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="scarifie" name="scarifie" <?php echo $condition['Scarifie'] ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="scarifie">Scarifié</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center">
                                ...
                                <a href="index.php?action=lister_conditions" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Retour</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            // Activer le sous-menu de la condition santé par défaut
