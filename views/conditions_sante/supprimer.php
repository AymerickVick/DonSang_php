...
<head>
    ...
    <title>Supprimer des Conditions de Santé</title>
            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-trash-alt"></i> Supprimer des Conditions de Santé</h1>
                    </div>
                ...
                <div class="form-container">
                    <div class="form-frame">
                        <p class="text-center mb-4">Êtes-vous sûr de vouloir supprimer les conditions de santé pour le donneur suivant ?</p>
                        <ul class="list-group mb-4">
                            <li class="list-group-item">ID Donneur : <?php echo $condition['ID_Donneur']; ?></li>
                            <li class="list-group-item">Raison de Non-Éligibilité : <?php echo $condition['Raison_Non_Eligibilite'] ?: 'Aucune'; ?></li>
                            <li class="list-group-item">Éligible : <?php echo $this->conditionSante->estEligible($condition['ID_Donneur']) ? 'Oui' : 'Non'; ?></li>
                        </ul>
                        <form action="index.php?action=supprimer_condition&id=<?php echo $condition['ID_Donneur']; ?>" method="POST" class="text-center">
                            <button type="submit" class="btn btn-danger"><i class="fas fa-trash me-2"></i>Oui, supprimer</button>
                            <a href="index.php?action=lister_conditions" class="btn btn-secondary"><i class="fas fa-times me-2"></i>Non, annuler</a>
                        </form>
                    </div>
                </div>
            </div>
