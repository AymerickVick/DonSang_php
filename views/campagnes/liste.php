...
<body>
            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-bullhorn"></i> Liste des Campagnes</h1>
                    </div>
                ...
                <a href="index.php?action=ajouter_campagne" class="btn btn-primary mb-4">
                    <i class="fas fa-plus me-2"></i> Ajouter une campagne
                </a>
                    ...
                    <table class="table custom-table">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-calendar-alt me-1"></i> Date Fin</th>
                                <th><i class="fas fa-map-marker-alt me-1"></i> Lieu</th>
                                <th><i class="fas fa-users me-1"></i> Nombre Donneurs</th>
                        ...
                        <tbody>
                            <?php foreach ($campagnes as $campagne): ?>
                                <tr>
                                    ...
                                    <td><?php echo $campagne['Nom_Campagne']; ?></td>
                                    <td><?php echo $campagne['Date_Debut']; ?></td>
                                    <td><?php echo $campagne['Date_Fin']; ?></td>
                                    <td><?php echo $campagne['Lieu']; ?></td>
                                    <td><?php echo $campagne['Nombre_Donneurs']; ?></td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="index.php?action=modifier_campagne&id=<?php echo $campagne['ID_Campagne']; ?>" class="btn btn-warning">
                                                <i class="fas fa-edit me-1"></i> Modifier
                                            </a>
                                            <button onclick="confirmDelete(<?php echo $campagne['ID_Campagne']; ?>)" class="btn btn-danger">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">Êtes-vous sûr de vouloir supprimer cette campagne ?</p>
    ...
    <script>
        ...
        function confirmDelete(id) {
            ...
            confirmButton.href = `index.php?action=supprimer_campagne&id=${id}`;
            deleteModal.show();
        }
