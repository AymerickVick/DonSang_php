            ...
            <div class="main-content" id="mainContent">
                <div class="page-header">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1><i class="fas fa-edit"></i> Modifier une Campagne</h1>
                    </div>
                ...
                <div class="form-container">
                    <div class="form-frame">
                        <form action="index.php?action=modifier_campagne&id=<?php echo $campagne['ID_Campagne']; ?>" method="POST" class="w-100">
                            <div class="form-row">
                                <div>
                                    <label for="nom_campagne" class="form-label">Nom de la Campagne</label>
                                    <input type="text" class="form-control" id="nom_campagne" name="nom_campagne" value="<?php echo $campagne['Nom_Campagne']; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="date_debut" class="form-label">Date de Début</label>
                                    <input type="date" class="form-control" id="date_debut" name="date_debut" value="<?php echo $campagne['Date_Debut']; ?>" required>
                                </div>
                                <div>
                                    <label for="date_fin" class="form-label">Date de Fin</label>
                                    <input type="date" class="form-control" id="date_fin" name="date_fin" value="<?php echo $campagne['Date_Fin']; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="lieu" class="form-label">Lieu</label>
                                    <input type="text" class="form-control" id="lieu" name="lieu" value="<?php echo $campagne['Lieu']; ?>" required>
                                </div>
                                <div>
                                    <label for="nombre_donneurs" class="form-label">Nombre de Donneurs</label>
                                    <input type="number" class="form-control" id="nombre_donneurs" name="nombre_donneurs" min="0" value="<?php echo $campagne['Nombre_Donneurs']; ?>">
                                </div>
                            </div>
